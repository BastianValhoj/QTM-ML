...
NK1S_ENUM = np.arange(300, 4001, step=300)
ETA = 1e-3

N_zig = [4*i+1 for i in range(2,7)]
N_arm = [2*i+1 for i in range(2,7)]
...
with h5py.File(DATA_DIR / "calc_dos_vs_nk1_sampling.h5", "w") as file:
