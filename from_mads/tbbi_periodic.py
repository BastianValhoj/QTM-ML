...
# def o2_SK_pz(rij, OP_tol = .5, Vpppi=-2.7,Vpps=0.48,d0_00=1.42,d0_01=3.35,q0_00=2.,q0_01=None,
#            IP_cutoff=1.6,OP_cutoff=6.,dangling=0.2,field=0.,eps=0.44, ):
#     V = np.zeros(len(rij))
#     sph    = o_cart_to_sph(rij)
#     l      = np.sin(sph[:,1])
#     d      = sph[:,0]
#     OP_hop = ( d < OP_cutoff )*( np.abs(rij[:,2])>OP_tol )
#     idx_inter = OP_hop.nonzero()[0]
